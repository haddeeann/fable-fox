<template>
  <BaseCard>
    <h1 class="text-2xl font-bold">New Story or Zine</h1>
    <p class="text-gray-600">Start with a spark. Keep it cozy, curious, or wonderfully odd, then send it for review when it feels ready.</p>
